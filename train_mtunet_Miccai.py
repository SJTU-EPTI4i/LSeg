...
from utils.test_Miccai_1_3 import inference
...
test_dataset = Task1Dataset(args.root_dir, split="test", transform=test_transform, target=args.target, size=args.img_size)
